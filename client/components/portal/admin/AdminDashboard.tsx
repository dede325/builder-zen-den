...
export default function AdminDashboard() {
  ...
  const userDistributionData = userMetrics
    ? [
        ...
        {
          name: "Recepcionistas",
          value: userMetrics.receptionists,
          color: COLORS[3],
        },
        {
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {systemStats
                      ? formatNumber(systemStats.totalAppointments)
                      : "--"}
                  </p>
                  <p className="text-xs text-green-600 mt-1">
                    {systemStats ? systemStats.completedAppointments : 0}{" "}
                    concluídas
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-green-600 mt-1">
                    +{systemStats ? formatMoney(systemStats.monthlyRevenue) : 0}{" "}
                    este mês
                  </p>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <Progress
                    value={systemStats?.bandwidthUsed || 0}
                    className="h-2"
                  />
                </div>
