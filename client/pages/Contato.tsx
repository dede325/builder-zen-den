              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                    <h4 className="font-semibold text-red-800 mb-2">Atendimento de Urgência</h4>
                    <p className="text-red-700 text-sm">24 horas por dia, 7 dias por semana</p>
                    <p className="text-red-700 text-sm mt-2">
                      <strong>Telefone de Emergência:</strong><br />
                      +244 945 344 650
                    </p>
                  </div>
                </CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link to="/exames" className="block text-gray-300 hover:text-white transition-colors">
                  Exames
                </Link>
              </div>
            </div>
