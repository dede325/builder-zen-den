...
export const formatDate = (
  ...
  format: keyof typeof angolaDateFormatters = "short",
): string => {
  const dateObj =
...
export const legalCompliance = {
  ...
  dataProtection: {
    ...
    retentionPeriod:
      "Os dados médicos são conservados por um período mínimo de 10 anos, conforme determinado pela legislação sanit��ria nacional.",
