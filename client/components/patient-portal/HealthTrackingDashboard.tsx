...
export default function HealthTrackingDashboard() {
  ...
  const [healthMetrics] = useState<HealthMetric[]>([
    ...
    // Steps data
    {
      ...
      value: 8500,
      unit: "passos",
      timestamp: "2024-12-20T23:59:00Z",
      target: 10000,
    },
    {
      id: "11",
    ...
    },
    {
      ...
      value: 7800,
      unit: "passos",
      timestamp: "2024-12-18T23:59:00Z",
    },
    ...
    return {
      steps: steps
        ? {
            ...
            percentage: Math.min(
              (Number(steps.value) / (steps.target || 10000)) * 100,
              100,
            ),
          }
        : null,
      water: water
        ? {
            ...
            percentage: Math.min(
              (Number(water.value) / (water.target || 2.5)) * 100,
              100,
            ),
          }
        : null,
      sleep: sleep
        ? {
            ...
            percentage: Math.min(
              (Number(sleep.value) / (sleep.target || 8)) * 100,
              100,
            ),
          }
        : null,
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-2">
                ...
                <Progress
                  value={todayProgress.steps.percentage}
                  className="h-2"
                />
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-2">
                ...
                <Progress
                  value={todayProgress.water.percentage}
                  className="h-2"
                />
                <div className="text-sm text-muted-foreground">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-2">
                ...
                <Progress
                  value={todayProgress.sleep.percentage}
                  className="h-2"
                />
                <div className="text-sm text-muted-foreground">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-muted-foreground">Tomadas hoje</div>
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span
                      className={`text-sm ${calculateTrend("weight") < 0 ? "text-green-500" : "text-red-500"}`}
                    >
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {getMetricsByType("blood_pressure")
                    .slice(-5)
                    .map((metric, index) => {
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground">
                            Próxima dose:{" "}
                            {format(new Date(medication.nextDose), "HH:mm")}
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
