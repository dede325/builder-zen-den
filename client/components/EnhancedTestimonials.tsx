...
const testimonials: Testimonial[] = [
  {
    ...
    content:
      "A Clínica Bem Cuidar salvou minha vida. O Dr. João Silva foi muito atencioso e profissional. Os exames foram realizados rapidamente e o diagnóstico foi preciso. Recomendo fortemente!",
  ...
  },
  {
    ...
    content:
      "Após meses de dor no joelho, finalmente encontrei alívio na Bem Cuidar. O Dr. Ricardo foi excepcional, explicou tudo detalhadamente e o tratamento foi muito eficaz.",
  ...
  },
  {
    ...
    content:
      "A Dra. Lucia é maravilhosa com crianças. Minha filha sempre tinha medo de médicos, mas aqui ela se sente confortável. O atendimento é humanizado e profissional.",
  ...
  },
  {
    ...
    content:
      "Sofria de problemas digestivos há anos. O Dr. Vítor não só identificou o problema rapidamente como também me orientou sobre mudanças no estilo de vida. Estou muito melhor!",
      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed">
            Histórias reais de pessoas que confiaram na Clínica Bem Cuidar para
          ...
          >
            <motion.div variants={staggerItem} className="text-center">
              ...
              <p className="text-2xl font-bold text-clinic-primary">
                      ...
                      <div className="flex items-center justify-center gap-4 pt-6 border-t border-clinic-accent/20">
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-xs text-gray-500">
                            {angolaFormatter.formatDate(
                              new Date(currentTestimonial.date),
                            )}
                          </p>
                        </div>
                      </div>
        ...
        >
          <ScaleOnHover>
            <GlassmorphismCard
              intensity="light"
              className="text-center p-6 bg-white/80"
            >
