...
export const mockMensagens: MensagemInterna[] = [
  {
    ...
    conteudo:
      "Precisamos urgentemente de um novo eletrocardi��grafo para o consultório.",
    dataEnvio: today,
    lida: false,
    arquivada: false,
    prioridade: "alta",
...
export const mockReceitaPeriodo: ReceitaPeriodo[] = [
  { mes: "2024-01", receita: 85420.5, despesas: 32150.3, lucro: 53270.2 },
  { mes: "2023-12", receita: 78900.0, despesas: 29800.5, lucro: 49099.5 },
  { mes: "2023-11", receita: 82340.75, despesas: 31200.25, lucro: 51140.5 },
];
