      ...
      examResults: [
        {
          ...
          notes: 'Valores dentro da normalidade. Hemoglobina: 14.2 g/dL, Leucócitos: 6.800/mm³, Plaquetas: 285.000/mm³',
          createdAt: new Date().toISOString(),
          updatedAt: new Date().toISOString()
        },
        {
          ...
          notes: 'Ritmo sinusal regular. Frequência cardíaca: 72 bpm. Eixo elétrico normal. Ausência de alterações significativas.',
          createdAt: new Date().toISOString(),
          updatedAt: new Date().toISOString()
        },
        {
          ...
          notes: 'Colesterol Total: 180 mg/dL, LDL: 110 mg/dL, HDL: 55 mg/dL, Triglicerídeos: 95 mg/dL. Valores adequados.',
          createdAt: new Date().toISOString(),
          updatedAt: new Date().toISOString()
        },
        {
        ...
        },
        {
          ...
          notes: 'TSH: 2.1 mUI/L, T4 Livre: 1.3 ng/dL. Função tireoidiana normal.',
          createdAt: new Date().toISOString(),
          updatedAt: new Date().toISOString()
        },
        {
        ...
        },
        {
          ...
          notes: 'Hemoglobina: 13.8 g/dL, Leucócitos: 7.200/mm³, Plaquetas: 295.000/mm³. Valores normais.',
          createdAt: new Date().toISOString(),
          updatedAt: new Date().toISOString()
        }
      ],
