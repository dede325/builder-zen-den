...
export default function SEOHead({
  ...
  return (
    <Helmet>
      ...
      <meta
        name="keywords"
        content="clínica médica luanda, médicos angola, cardiologia luanda, pediatria angola, exames médicos luanda, seguro saúde angola, consulta médica online angola, hospital luanda, cirurgia angola, diagnóstico médico luanda"
      />
      ...
      <meta
        ...
        content="Clínica Bem Cuidar - Instalações modernas em Luanda"
      />
      ...
      <meta
        ...
        content="As informações neste website não substituem o aconselhamento médico profissional. Consulte sempre um médico qualificado."
      />
      <meta
        name="healthcare-provider"
        content="Clínica Bem Cuidar, Luanda, Angola"
      />
      <meta
        name="medical-license"
        content="Licenciada pela Ordem dos Médicos de Angola"
      />

      {/* Business Information */}
      <meta
        name="business-hours"
        content="Segunda-Sexta: 07:00-19:00, Sábado: 07:00-13:00"
      />
      <meta name="contact-phone" content="+244945344650" />
      <meta name="contact-email" content="recepcao@bemcuidar.co.ao" />
      <meta
        name="business-address"
        content="Avenida 21 de Janeiro, Nº 351, Benfica, Luanda, Angola"
      />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          name: "Clínica Bem Cuidar",
          description:
            "Website oficial da Clínica Bem Cuidar em Luanda, Angola",
          publisher: {
            "@id": "https://bemcuidar.co.ao",
          },
          potentialAction: [
            {
              ...
              target: {
                "@type": "EntryPoint",
                urlTemplate:
                  "https://bemcuidar.co.ao/buscar?q={search_term_string}",
              },
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          name: "Clínica Bem Cuidar",
          description:
            "Clínica médica especializada oferecendo cuidados de saúde de alta qualidade em Luanda, Angola",
          url: "https://bemcuidar.co.ao",
          logo: "https://bemcuidar.co.ao/logo.png",
          contactPoint: {
            "@type": "ContactPoint",
...
export const generatePageSEO = (
  ...
  const seoConfigs = {
    especialidades: {
      ...
      description:
        "Conheça nossas especialidades médicas: Cardiologia, Pediatria, Cirurgia Geral, Dermatologia e mais. Especialistas qualificados em Luanda, Angola.",
      structuredData: {
        "@context": "https://schema.org",
    ...
    contato: {
      ...
      description:
        "Entre em contato com a Clínica Bem Cuidar. Agende sua consulta online ou por telefone. Estamos em Benfica, Luanda, Angola.",
      structuredData: {
        "@context": "https://schema.org",
        "@type": "ContactPage",
    ...
    sobre: {
      ...
      description:
        "Conheça a história da Clínica Bem Cuidar, nossa missão de proporcionar cuidados de saúde de excelência em Luanda, Angola.",
      structuredData: {
        "@context": "https://schema.org",
        "@type": "AboutPage",
