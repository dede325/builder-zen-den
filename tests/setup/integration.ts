...
export const generateMockAppointments = (count = 10) => {
  ...
  return Array.from({ length: count }, (_, i) => createTestAppointment({
    id: `appointment-${i + 1}`,
...
// API test helpers
export const makeAuthenticatedRequest = async (method: string, path: string, data?: any) => {
...
export const createTestFile = (name = 'test.pdf', type = 'application/pdf', content = 'test content') => {
