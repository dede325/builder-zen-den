        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button
                asChild
                className="bg-clinic-gradient text-white hover:opacity-90 border-0"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground">
                Ampla gama de exames diagnósticos organizados por área médica
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground">
                Processo simples e organizado para sua comodidade
              </p>
            </div>

            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-clinic-gradient rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl">
                  1
                </div>
                <h3 className="font-semibold mb-2">Agendamento</h3>
                <p className="text-sm text-muted-foreground">
                  Agende por telefone, WhatsApp ou pelo Portal do Paciente
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Siga as orientações de preparação específicas para cada exame
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2">Realização</h3>
                <p className="text-sm text-muted-foreground">
                  Compare na data agendada e realize o exame com nossa equipe
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Acesse seus resultados online ou retire na recepção
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="mt-8 text-sm opacity-80">
              <p>Atendimento de Segunda a Sexta das 07:00 às 19:00</p>
              <p>Sábados das 07:00 às 13:00</p>
            </div>
          </div>
        </div>
      </section>
