    ...
    <div className="min-h-screen bg-gradient-to-br from-clinic-light/20 via-white to-clinic-secondary/10 flex items-center justify-center p-4">
      ...
      >
        <Card className="shadow-2xl border-0 overflow-hidden">
          <CardHeader className={`${currentConfig.bgColor} ${currentConfig.borderColor} border-b-2 text-center pb-8`}>
            <motion.div
              key={selectedRole}
        ...
        >
          <p className="text-sm text-gray-600">
            ...
            <a href="tel:+244923456789" className="font-semibold text-clinic-primary">
              +244 923 456 789
            </a>
          </p>
        </motion.div>
