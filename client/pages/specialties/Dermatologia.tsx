...
const dermatologiaInfo = {
  ...
  icon: Shield,
  fullDescription:
    "A Dermatologia é a especialidade médica que cuida da saúde da pele, cabelos, unhas e mucosas. Nossa equipe oferece tratamentos preventivos, diagnósticos e terapêuticos para todas as condições dermatológicas, desde cuidados estéticos até tratamentos de doenças complexas.",
  benefits: [
