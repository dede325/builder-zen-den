  ...
  async processUploadedFile(
    ...
    const processedFile: ProcessedFile = {
      ...
      compressedUrl: compressedPath
        ? `/api/files/${fileRecord.id}/compressed`
        : undefined,
    };
  ...
  async getUserFiles(
    ...
    return files.map((file) => ({
      ...
      thumbnailUrl: file.thumbnail_path
        ...
        : undefined,
      compressedUrl: file.compressed_path
        ? `/api/files/${file.id}/compressed`
        : undefined,
    }));
  }
