  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'clinic-gradient': 'linear-gradient(135deg, hsl(var(--clinic-primary)) 0%, hsl(var(--clinic-secondary)) 100%)',
        'clinic-gradient-soft': 'linear-gradient(135deg, hsl(var(--clinic-primary) / 0.1) 0%, hsl(var(--clinic-secondary) / 0.1) 100%)',
        'clinic-hero': 'linear-gradient(135deg, hsl(var(--clinic-primary) / 0.05) 0%, hsl(var(--clinic-secondary) / 0.05) 100%)',
        // Gradientes para estados
        'success-gradient': 'linear-gradient(135deg, hsl(var(--success)) 0%, hsl(var(--success) / 0.8) 100%)',
        'warning-gradient': 'linear-gradient(135deg, hsl(var(--warning)) 0%, hsl(var(--warning) / 0.8) 100%)',
        'info-gradient': 'linear-gradient(135deg, hsl(var(--info)) 0%, hsl(var(--info) / 0.8) 100%)',
      },
      borderRadius: {
        lg: "var(--radius)",
