                ...
                <div className="mt-2 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <p className="text-sm leading-relaxed">
                    {exame.resultado_texto ||
                      "Resultado em texto não disponível."}
                  </p>
                </div>
              </div>
            </TabsContent>
...
export default function ExamesPage() {
  ...
  const [selectedExame, setSelectedExame] = useState<ExamePaciente | null>(
    null,
  );
  ...
  const statusCounts = {
    ...
    resultado_disponivel: exames.filter(
      (e) => e.status === "resultado_disponivel",
    ).length,
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              {statusCounts.resultado_disponivel}
            </div>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <Select
              ...
              onValueChange={(value: FiltroExames["periodo"]) =>
                handleFiltroChange("periodo", value)
              }
            >
              <SelectTrigger>
            ...
            >
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  ...
                  <Badge
                    className={cn("ml-2", statusConfig[exame.status].color)}
                  >
