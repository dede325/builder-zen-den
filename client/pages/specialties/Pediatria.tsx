...
const pediatriaInfo = {
  name: "Pediatria",
  description:
    "Cuidados médicos especializados para bebês, crianças e adolescentes",
  icon: Baby,
  fullDescription:
    "A Pediatria é a especialidade médica dedicada à assistência à criança e ao adolescente, nos seus diversos aspectos, sejam eles preventivos ou curativos. Nossa equipe pediátrica oferece cuidados abrangentes desde o nascimento até os 18 anos, priorizando o desenvolvimento saudável e o bem-estar integral de cada paciente.",
  benefits: [
  ...
  procedures: [
    {
      ...
      description:
        "Acompanhamento regular do crescimento e desenvolvimento da criança.",
      duration: "30 minutos",
    ...
    },
    {
      name: "Vacinação",
      description:
        "Aplicação de vacinas conforme calendário nacional e internacional.",
      duration: "15 minutos",
    ...
    },
    {
      name: "Nebulização",
      description:
        "Tratamento de problemas respiratórios com medicação inalatória.",
      duration: "20 minutos",
