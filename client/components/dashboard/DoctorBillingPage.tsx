  ...
  return (
    <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
      <DialogHeader>
        ...
        <DialogDescription>Detalhes e ações da fatura</DialogDescription>
      </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-2 text-sm">
                <p>
                  <strong>Nome:</strong> {invoice.patientName}
                </p>
                <p>
                  <strong>Email:</strong> {invoice.patientEmail}
                </p>
                <p>
                  <strong>Telefone:</strong> {invoice.patientPhone}
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-2 text-right">
              <div className="flex justify-end space-x-4">
                ...
                <span>
                  R${" "}
                  {invoice.subtotal.toLocaleString("pt-BR", {
                    minimumFractionDigits: 2,
                  })}
                </span>
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <div className="space-y-1 text-sm">
                  <p>
                    <strong>Nome:</strong> {invoice.doctorName}
                  </p>
                  <p>
                    <strong>CRM:</strong> 123456
                  </p>
                  <p>
                    <strong>Especialidade:</strong> Cardiologia
                  </p>
                </div>
              </div>
            </div>
    ...
    if (dateFilter !== "all") {
      ...
      switch (dateFilter) {
        ...
        case "week":
          ...
          filtered = filtered.filter(
            (invoice) => new Date(invoice.issueDate) >= filterDate,
          );
          break;
        case "month":
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {statusCounts.paid} faturas pagas
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {statusCounts.sent} faturas enviadas
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {statusCounts.overdue} faturas vencidas
            </p>
          </CardContent>
        </Card>
        <Card>
