  ...
  const defaultItems: GalleryItem[] = [
    {
      ...
      description: "Ambiente acolhedor e moderno para receber nossos pacientes com conforto e eficiência.",
    ...
    },
    {
      ...
      description: "Consultório especializado equipado com tecnologia avançada para diagnósticos cardiológicos precisos.",
    ...
    },
    {
      ...
      description: "Laboratório moderno com equipamentos de última geração para análises clínicas completas.",
    ...
    },
    {
      ...
      description: "Ambiente preparado para exames de ecocardiograma com equipamentos de alta resolução.",
    ...
    },
    {
      ...
      description: "Centro cirúrgico com tecnologia de ponta e ambiente esterilizado para procedimentos seguros.",
    ...
    },
    {
      ...
      description: "Ambiente lúdico e acolhedor especialmente projetado para o atendimento de crianças.",
    ...
    },
    {
      ...
      description: "Equipamentos modernos de radiologia digital para exames de imagem de alta qualidade.",
    ...
    },
    {
      ...
      description: "Farmácia interna com medicamentos selecionados e atendimento farmacêutico especializado.",
    ...
    },
    {
      ...
      description: "Ambiente exclusivo para pacientes com atendimento personalizado e maior privacidade.",
      imageUrl: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      category: "recepcao",
    ...
    },
    {
      ...
      description: "Consultório especializado com iluminação adequada para exames dermatológicos detalhados.",
      imageUrl: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      category: "consultorios",
    ...
    },
    {
      ...
      description: "Ambiente tranquilo e monitorado para recuperação pós-procedimentos e cirurgias.",
      imageUrl: "https://images.unsplash.com/photo-1631815588090-d4bfec5b1ccb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      category: "cirurgia",
    ...
    },
    {
      ...
      description: "Aparelho de ultrassom de última geração para exames precisos e detalhados.",
      imageUrl: "https://images.unsplash.com/photo-1576602976047-174e57a47881?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
              ...
              <div className="absolute bottom-2 left-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="flex flex-wrap gap-1">
                  {item.tags.slice(0, 2).map((tag, index) => (
                    <Badge key={index} variant="secondary" className="text-xs bg-white/90 text-black">
                      {tag}
                    </Badge>
                  ))}
                </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedItem.tags.map((tag, index) => (
                    <Badge key={index} variant="outline" className="text-clinic-primary border-clinic-primary">
                      {tag}
                    </Badge>
                  ))}
                </div>
