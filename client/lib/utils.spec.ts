  ...
  it('should validate vital signs ranges', () => {
    const isValidVitalSigns = (vitals: {
      ...
      return (
        ...
        vitals.oxygenSaturation >= 95 && vitals.oxygenSaturation <= 100
      );
    };

    expect(isValidVitalSigns({
      heartRate: 72,
      temperature: 36.8,
      oxygenSaturation: 98
    })).toBe(true);
...
describe('Search Utilities', () => {
  it('should perform fuzzy search correctly', () => {
    ...
    expect(fuzzySearch('heart surgery', 'Heart surgery consultation')).toBe(true);
...
describe('Error Handling', () => {
  ...
  it('should validate required fields', () => {
    ...
    const result = validateRequiredFields(appointmentData, ['patientName', 'doctorId', 'date', 'time']);
