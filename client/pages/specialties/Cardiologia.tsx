...
const cardiologyInfo = {
  ...
  icon: Heart,
  fullDescription: 'A Cardiologia é a especialidade médica que se dedica ao diagnóstico, tratamento e prevenção das doenças do coração e do sistema cardiovascular. Nossa equipe de cardiologistas utiliza tecnologia de ponta para oferecer cuidados personalizados e tratamentos eficazes para todas as condições cardíacas.',
  benefits: [
  ...
  procedures: [
    ...
    {
      name: 'Ecocardiograma',
      description: 'Ultrassom do coração que avalia a estrutura e função cardíaca.',
      duration: '30 minutos',
      preparation: 'Jejum de 2 horas'
    },
    {
      name: 'Teste de Esforço',
      description: 'Avaliação da resposta cardiovascular durante exercício físico controlado.',
      duration: '45 minutos',
    ...
    },
    {
      ...
      description: 'Procedimento invasivo para avaliação das artérias coronárias.',
