...
describe("Clinic Workflow Integration Tests", () => {
  ...
  describe("Medical Staff Workflow", () => {
    it("should complete nurse pre-consultation workflow", async () => {
      ...
      const vitalSignsData = {
        ...
        respiratory_rate: 16,
        notes:
          "Paciente apresenta sinais vitais normais, relatando leve ansiedade",
      };
      ...
      const messageToDoctor = {
        ...
        to_user_id: "doctor-1",
        message:
          "Paciente João Silva preparado para consulta. Sinais vitais registrados. PA: 125/82, FC: 78.",
        type: "text",
      };
    ...
    it("should complete doctor consultation workflow", async () => {
      ...
      const medicalRecordData = {
        ...
        historyOfPresentIllness:
          "Paciente refere dor em aperto, retroesternal, que piora aos esforços",
        physicalExamination:
          "BEG, corado, hidratado. CV: RCR 2T BNF. AR: MV presente bilateralmente",
  ...
  describe("Analytics and Reporting", () => {
    ...
    it("should generate patient demographics report", async () => {
      ...
      expect(demographicsResponse.body.data).toHaveProperty(
        "genderDistribution",
      );
    });
  });
