...
const mockExamResults: ExamResult[] = [
  ...
  },
  {
    ...
    recommendations:
      "Coração funcionando normalmente. Manter atividade física regular.",
...
const mockMessages: Message[] = [
  {
    ...
    content:
      "Olá Maria! Sua consulta com Dr. António Silva está confirmada para 25/12/2024 às 09:00. Por favor, chegue 15 minutos antes. Lembre-se de trazer seu cartão do plano de saúde.",
    type: "appointment",
    priority: "normal",
    read: false,
    replied: false,
  ...
  },
  {
    ...
    content:
      "Olá Maria! Seus resultados de exames já estão disponíveis no portal. Tudo está normal. Caso tenha dúvidas, não hesite em entrar em contato.",
    type: "exam",
    priority: "normal",
    read: true,
...
const mockInvoices: Invoice[] = [
  {
    ...
    dueDate: "2024-12-30",
    notes:
      "Pagamento pode ser efetuado na recepção ou via transferência bancária.",
...
export const useMedicalStore = create<MedicalState>((set, get) => ({
  ...
  fetchExamResults: async (patientId: string) => {
    ...
    const userExams = mockExamResults.filter(
      (exam) => exam.patientId === patientId,
    );
