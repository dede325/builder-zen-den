...
export default function EnhancedIndex() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-x-hidden">
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden lg:flex items-center space-x-8">
                {['Início', 'Especialidades', 'Exames', 'Sobre', 'Contato'].map((item, index) => (
                  <motion.a
                    key={item}
            ...
            >
              <div className="space-y-3 pb-4">
                {['Início', 'Especialidades', 'Exames', 'Sobre', 'Contato'].map((item) => (
                  <a
                    key={item}
                    href={`#${item.toLowerCase()}`}
            ...
            {[
              {
                ...
                description: "Tecnologia avançada e profissionais experientes para diagnósticos precisos e ágeis",
                color: "from-blue-400 to-blue-600"
              },
              {
                icon: Heart,
                title: "Atendimento Humanizado", 
                description: "Cuidado personalizado com foco no conforto e bem-estar de cada paciente",
                color: "from-red-400 to-red-600"
              },
              {
                icon: Award,
                title: "Excelência Médica",
                description: "Equipe de especialistas qualificados com anos de experiência e dedicação",
              ...
              <ScaleOnHover key={index}>
                ...
                >
                  <FloatingElement duration={3 + index} intensity={8} delay={index * 0.5}>
        ...
        <div className="container mx-auto px-6">
          <FadeInScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                Especialistas qualificados em diversas áreas para cuidar da sua saúde de forma integral.
              </p>
            </div>
          </FadeInScroll>
      ...
      <section id="contato" className="py-20 lg:py-32 bg-gradient-to-br from-clinic-light/30 to-white">
        <div className="container mx-auto px-6">
          <FadeInScroll>
            <div className="text-center mb-16">
              <Badge variant="outline" className="mb-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <FadeInScroll direction="left">
              <div className="space-y-8">
                <GlassmorphismCard intensity="light" className="p-6 bg-white/60">
